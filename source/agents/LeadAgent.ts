...
import { SqlGeneratorTool } from "./tools/impl/SqlGeneratorTool";
import { SqlExecutorTool } from "./tools/impl/SqlExecutorTool";
import { LeadSummarizerTool } from "./tools/impl/LeadSummarizerTool";
...
export class LeadAgent
{
    ...
    constructor(enforce: () => void)
    {
        ...
        const tools: ToolInterface[] = [
            SqlGeneratorTool.getInstance(),
            SqlExecutorTool.getInstance(),
            LeadSummarizerTool.getInstance()
        ];
