...
class PriceDataValidator {
    ...
    static validateFetchByStateAndManufacturerIdsSchema(data) {
        return (0, SetupValidator_1.setupValidator)(data, PriceDataValidator.fetchByStateAndManufacturerIdsSchema);
    }
    static validateFetchByIdRequestBody(data) {
        return (0, SetupValidator_1.setupValidator)(data, PriceDataValidator.fetchByIdRequestBodySchema);
    }
