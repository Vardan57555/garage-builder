...
let FailedJobs = class FailedJobs extends sequelize_typescript_1.Model {
};
__decorate([
...
], FailedJobs.prototype, "failed_at", void 0);
FailedJobs = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "failed_jobs", timestamps: false })
], FailedJobs);
