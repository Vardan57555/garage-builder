...
let ExtraPanels = class ExtraPanels extends sequelize_typescript_1.Model {
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", String)
], ExtraPanels.prototype, "is_panel_jtrim", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.FLOAT, allowNull: false }),
    __metadata("design:type", Number)
], ExtraPanels.prototype, "cut_panel_jtrim", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.ENUM("yes", "no", "included"), allowNull: false, defaultValue: "no" }),
    __metadata("design:type", String)
], ExtraPanels.prototype, "is_cut_panel_jtrim", void 0);
ExtraPanels = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "extra_panels", timestamps: false })
], ExtraPanels);
exports.default = ExtraPanels;
//# sourceMappingURL=ExtraPanels.js.map