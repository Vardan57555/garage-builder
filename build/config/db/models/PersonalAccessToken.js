...
let PersonalAccessToken = class PersonalAccessToken extends sequelize_typescript_1.Model {
};
__decorate([
...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.DATE, allowNull: true }),
    __metadata("design:type", Date)
], PersonalAccessToken.prototype, "expires_at", void 0);
__decorate([
...
PersonalAccessToken = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "personal_access_tokens", timestamps: true })
], PersonalAccessToken);
