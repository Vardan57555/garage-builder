...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.CHAR(2), allowNull: false }),
    __metadata("design:type", String)
...
__decorate([
    ...
    __metadata("design:type", Number)
], State.prototype, "region_id", void 0);
State = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "states", timestamps: false })
], State);
