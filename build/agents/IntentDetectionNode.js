...
const detectGarageIntentNode = async (state) => {
    ...
    try {
        ...
        if (!hasIntent) {
            ...
            return {
                hasGarageIntent: false,
                response: "Hello! I can help you get a price quote for a garage or metal building.\n\n" +
...
exports.detectGarageIntentNode = detectGarageIntentNode;
//# sourceMappingURL=IntentDetectionNode.js.map