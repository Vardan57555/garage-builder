...
exports.showFinalPriceNode = void 0;
const Log_1 = require("../../../utils/logger/Log");
const LeadAgentHelpers_1 = require("../../LeadAgentHelpers");
const logger = (0, Log_1.createLogger)(module);
function extractBasePrice(pricingData) {
    if (pricingData.base_price_regular)
        return pricingData.base_price_regular;
    if (pricingData.base_price_box)
        return pricingData.base_price_box;
    if (pricingData.base_price_vertical)
        return pricingData.base_price_vertical;
    let total = 0;
    const numericFields = [
...
const showFinalPriceNode = async (state) => {
...
exports.showFinalPriceNode = showFinalPriceNode;
//# sourceMappingURL=ShowFinalPriceNode.js.map