...
exports.GenericChoiceManager = exports.ChoiceHandler = void 0;
...
class ChoiceHandler {
    ...
    async parseUserChoiceWithAI(userInput, options, context = "") {
        try {
            this.logger.info({ userInput, optionCount: options.length }, "[ChoiceHandler] Parsing user choice");
    ...
    async chooseWithAI(userInput, options, context) {
        try {
            ...
            if (!isValid) {
                this.logger.warn(`[chooseWithAI] AI selected invalid option: ${result.selected}, using default`);
                return {
                    selected: options[0].value,
                    confidence: "low",
