...
exports.detectResetIntent = detectResetIntent;
exports.detectParameterUpdateFromInput = detectParameterUpdateFromInput;
const Log_1 = require("../../../utils/logger/Log");
const logger = (0, Log_1.createLogger)(module);
function detectResetIntent(input) {
    const resetPatterns = [
...
async function detectParameterUpdateFromInput(input) {
...
//# sourceMappingURL=DetectionHelpers.js.map